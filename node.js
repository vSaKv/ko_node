...
(function () {
    ...
    var redis = require('redis'), http = require('http'), crypto = require('crypto'), url = require("url"), cluster = require('cluster');
    http.globalAgent.maxSockets = 1000;

    /**
     * module for fetching data from queue (Redis) and delivering payload to destination with crashproof and safe shutdown
     *
     * @constructor
     */
    function Consumer() {
         ...
         *
         * @type {{
         * responseTimeOut: number,     how long to wait for response
         * crashTimeOut: number,        how long to wait before consider client is crashed and retry to send request
         * activeConnections: number,   concurrent connections
         * deliveryAttempts: number[],  time betweem delivery attempts where number in seconds between and array length amount of attempts
         * unknownKeyValue: string,     value to replace unmatched key in placeholder
         * enableCluster: boolean,      run client in cluster mode to utilize available CPU cores
         * numCPUs: number}}            how many CPU
         */
        this.config = {
            responseTimeOut: 10,
            crashTimeOut: 30,
            activeConnections: 800,
            deliveryAttempts: [300, 300, 300, 300],
            unknownKeyValue: "test",
            enableCluster: false,
        ...
        /**
         * saving result received from servers
         * @param typeReq
         * @param {string} loadHash
         * @param {number} statusCode
         * @param {string} body
         * @param {number} deliveryAttempt
         * @param {number} responseFinished
         */
        ...
        /**
         * sending GET request with payload
         *
         * @param {string} loadBody
         * @callback callback
         */
